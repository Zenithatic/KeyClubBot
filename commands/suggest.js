...
const data = {
    ...
    async execute(interaction){
        ...
        const embed1 = new Discord.EmbedBuilder()
            ...
            .setDescription('Thanks for suggesting! To verify, here is your suggestion information. If there was a mistake, please DM Patrick W, the vice president. Thanks!\n\u200B')
